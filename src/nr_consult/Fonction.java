...
import static nr_consult.Service.test;
...
Connection conn = null;
     ...
     */
    public Fonction() {  conn = ConexionBD.Conexion();
        initComponents();
        Affichage();
 ...
 public void Affichage() {
        try {
            ...
            rs = ps.executeQuery();
            table_fonction.setModel(DbUtils.resultSetToTableModel(rs));
 ...
 public void Deplace() {
        try {
            ...
            int row = table_fonction.getSelectedRow();
            this.test = (table_fonction.getModel().getValueAt(row, 0).toString());
            String requet = " select * from  fonction where id_fonction = '" + test + "' ";
            ps = conn.prepareStatement(requet);
            rs = ps.executeQuery();

            if (rs.next()) {
                String t1 = rs.getString("id_fonction");
                txt_id.setText(t1);
               String t2 = rs.getString("fonction");
                txt_fonction.setText(t2);
...
ps.close();
    ...
    private void initComponents() {
        ...
        table_fonction.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                table_fonctionMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(table_fonction);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(72, 50, 630, 227);
        getContentPane().add(txt_fonction);
        txt_fonction.setBounds(290, 360, 250, 40);

        jLabel1.setFont(new java.awt.Font("Tekton Pro Ext", 0, 18)); // NOI18N
        jLabel1.setText(" Id Fonction :");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(170, 300, 150, 30);
        ...
        btnajout.setBounds(40, 440, 160, 40);
        ...
        btnmodif.setBounds(200, 440, 180, 40);
        ...
        btnsuppr.setBounds(380, 440, 180, 40);
        ...
        jButton5.setBounds(560, 440, 180, 40);
        ...
        jLabel3.setBounds(0, -20, 810, 610);

        setSize(new java.awt.Dimension(811, 571));
        setLocationRelativeTo(null);
    }// </editor-fold>//GEN-END:initComponents

    private void table_fonctionMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_table_fonctionMouseClicked
btnajout.setEnabled(false);

        btnmodif.setEnabled(true);
        btnsuppr.setEnabled(true);    Deplace();        // TODO add your handling code here:
    }//GEN-LAST:event_table_fonctionMouseClicked
    ...
    private void btnajoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnajoutActionPerformed
        if (txt_fonction.getText().equals("") ) {
            ...
            try {
                ...
                String requete = "insert into fonction (fonction) values (?)";
                ps = conn.prepareStatement(requete);
                ps.setString(1, txt_fonction.getText());
...
String t1 = txt_id.getText();
        ...
        try { 
            String requete = "update fonction set id_fonction=?, fonction=? where  id_fonction ='" + t1 + "'";
       
            ps = conn.prepareStatement(requete);
            ps.setString(1, txt_id.getText());
            ps.setString(2, txt_fonction.getText());
 ...
 ps.close();
  ...
  try {
            if (JOptionPane.showConfirmDialog(null, "attention vous devez suprimer une fonction ,est ce que vous êtes sur?",
                    "Supprimer fonction", JOptionPane.YES_NO_OPTION) == JOptionPane.OK_OPTION) {
                if (txt_id.getText().length() != 0) {

                    String requete = "delete from fonction where id_fonction = ?";
                    ps = conn.prepareStatement(requete);
                    ps.setString(1, txt_id.getText());
                    ps.execute();
                ...
                Affichage();
                    ...
                    JOptionPane.showMessageDialog(null, "veuillez choisir  une fonction !");
                }
            }
              ps.close();
                rs.close();
...
this.dispose();     // TODO add your handling code here:
    ...
    private javax.swing.JTable table_fonction;
